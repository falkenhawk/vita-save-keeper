...
// newest_backup_by_folder maps normalized save folder names to the newest backup name on either
// side, card or Drive (timestamped names compare lexically); saves without any backup sort last.
